        ...
        <Grid container spacing={2}>
          <Grid item xs={12}>
            <Box className="socialicon_wrap">
              <a href="https://twitter.com/cashminer" target="_blank">
                <SocailIcon><TwitterIcon /></SocailIcon>
              </a>
              <a href="https://t.me/cashminer" target="_blank">
                <SocailIcon><TelegramIcon /></SocailIcon>
              </a>
              <a href="https://discord.gg/ZC4Q49e8u3" target="_blank">
            ...
            <Box className="socialicon_wrap">
              ...
              <a href="https://cashminer.gitbook.io/cashminer/" target="_blank">
